...
wget "https://raw.githubusercontent.com/CompulsiveCoder/ArduinoPlugAndPlay/dev/svc/$SERVICE_FILE_NAME" -O $PACKAGE_FILE_EXT || (echo "Failed to download $SERVICE_FILE_NAME." && exit 1)
